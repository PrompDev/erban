...
import { startSignin, getState as getSigninState, getActiveProvider, listProviders, reopenSignin } from './provider-auth.mjs'
...
function handle (payload, reply) {
  ...
  try {
    ...
    if (m.action === 'signin-reopen') {
      const r = reopenSignin()
